import { Button, Center, FlexBox, Grid, H1, H4, LayoutContextProps, Padding, Page, Paragraph, SignInButton } from '@cd/ui-lib';
                        ...
                        <Padding>
                            <FlexBox className="max-w-[400px]">
                                <Paragraph className="whitespace-pre-line">
                                    To browse for cannabis products, you must be 21 years of age or older.
                                    Please sign in.
                                </Paragraph>
                            </FlexBox>
                        </Padding>
