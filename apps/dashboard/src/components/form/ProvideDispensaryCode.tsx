    ...
    <form onSubmit={handleSubmit}>
      <Grid className="min-h-[320px] w-full items-center justify-center flex flex-col text-center space-y-4">
          ...
          <Paragraph className="text-primary">
            You'll need a <b>dispensary code</b> to create your Dispensary account.
            <br />
            If you don't have one, email our team at{' '}
            <a className="underline" href="mailto::support@grascannabis.org?subject=Get my Dispensary Code!&body=I want to create a Dispensary account. I'm claiming my Dispensary code. Thank you!">
