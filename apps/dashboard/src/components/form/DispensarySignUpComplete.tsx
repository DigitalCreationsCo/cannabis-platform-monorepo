...
function DispensarySignUpComplete () {
    ...
    return (
        <div>
            <Confetti className='w-full h-full' numberOfPieces={420} recycle={false} />
        <Grid className="max-w-[525px] mx-auto pt-20 md:pt-8 space-y-2">
            <FlexBox className='flex-row justify-between'>
                <H2 className='whitespace-normal'>Congratulations, you created a Dispensary Account with Gras.</H2>
                {/* <Paragraph>
