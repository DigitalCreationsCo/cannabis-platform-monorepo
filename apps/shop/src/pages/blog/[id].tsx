...
import { FlexBox, H2, H3, LayoutContextProps, Page, Paragraph, Small } from "@cd/ui-lib";
    ...
    return (
        <Page className="mx-auto">
            <FlexBox className="grow m-auto">
                ...
                <img src={blog.image.location || logo.src } alt={blog.name} className="w-60" />
                <Paragraph>{ blog.description }</Paragraph>
                <div className="grow"></div>
                <Small>{TextContent.info.THANK_YOU} {TextContent.info.MORE_CONTENT_COMING_SOON}</Small>
            </FlexBox>
        </Page>
    );
}
