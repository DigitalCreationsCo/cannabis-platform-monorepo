...
function Support() {
    return (
        <ProtectedComponent><Page className="md:max-w-1/2">
            <PageHeader
                title='Support' Icon={ Icons.Shield }
            />
            ...
            For software support, please dial the toll-free support phone number. `}</H5>
                <H4 className='text-left whitespace-pre-line'>{ 
                `24 / 7 Gras Support Phone Number: 
                1-800-GREEN-35`}</H4>
                </Grid>
        </Page></ProtectedComponent>
    );
}
