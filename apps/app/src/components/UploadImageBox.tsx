...
type UploadImageBoxProps = { onClick?: any; onKeyUp?: any } & PropsWithChildren;

const UploadImageBox = ({ onClick, onKeyUp, children }: UploadImageBoxProps) => {
    const styleUploadWindow = [
        'h-[80px] w-[80px] border flex rounded-btn relative items-center justify-center bg-light',
    ];
    return (
