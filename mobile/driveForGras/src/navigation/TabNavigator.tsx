    ...
    >
      <Tab.Screen
        ...
        options={{
          ...
          tabBarShowLabel: true, tabBarLabel: 'Account', tabBarActiveTintColor: 'green'
        }}
      />
      <Tab.Screen
      ...
      options={{
        ...
        tabBarShowLabel: true, tabBarLabel: 'Delivery', tabBarActiveTintColor: 'green'
      }}
    />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarShowLabel: true, tabBarLabel: 'Orders', tabBarActiveTintColor: 'green'
        }}
      />
    </Tab.Navigator>
  );
