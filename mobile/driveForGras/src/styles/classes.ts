const RNstyles = Object.freeze({
	...
	textfield: {
		inputContainer: [
			'bg-light shadow',
			'w-full p-2 flex flex-col space-y-4 justify-between',
			'rounded',
		],
	...
	card: {
		container:
			'h-max w-full md:!w-5/6 lg:!w-2/3 bg-light flex flex-col shadow drop-shadow max-w-screen p-2 !pb-12 md:p-5 md:px-12 !rounded-none md:!rounded-btn',
	},

	footer:
		'space-y-2 flex-col min-h-[188px] p-12 pb-24 lg:px-[248px] bg-secondary min-w-full bottom-0',
});
