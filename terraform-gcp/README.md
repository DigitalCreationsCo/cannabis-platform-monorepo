...
_Image 1: 3 node GKE Cluster, with a total of 24 GB of RAM, and 6 cores._

![Cost Over 10 Days](images/cost-over-10-days.png)
_Image 2: Total (all inclusive) cost of running the GKE cluster over 10 days._

![Spot Discounts](images/us-west4-spot-discounts.png)
_Image 3: Spot VM pricing in us-west4._
...
1. _Is this GKE cluster, given the drawbacks of Spot VM nodes, really all that useful?_
...
4. _How can I guarantee that my applications will stay online if multiple Spot VM nodes are replaced at the same time?_
...
5. _Why do I have `Terminated` pods and how can I get rid of them?_
...
6. _What GCP regions are compatible with this solution?_
...
7. _What about HTTPS/TLS termination for the HTTP Load Balancer?_
...
8. _Can I do TCP passthrough rather than HTTP for the Regional Load Balancer?_
...
9. _Can I use an Ingress Controller implementation such as NGINX instead of Gloo Edge?_
...
10. _In the Google Cloud console, why don't I don't see the deployed Load Balancer?_
...
11. _What if I have stateful workloads such as a PostgreSQL database?_
...
12. _Are there data transfer (ingress/egress) charges for Google Cloud that apply?_
...
13. _How do I use a domain name with my cluster?_
...
14. _How do I update my SSL certificate without redeploying?_
...
15. _Can I run more GKE nodes with the same cost model?_
