...
export const Span = ({ className, children, ...props }: Props) => {
    return (
        <Text className={twMerge(styles['cursor-inherit'], 'text-md inline whitespace-normal', className)} {...props }>
            {children}
        </Text>
    );
};
...
export const Tiny = ({ className, children }: Props) => {
    return (
        <Text className={twMerge(styles['cursor-inherit'], 'text-xs whitespace-normal', className)}>{children}</Text>
    );
};
