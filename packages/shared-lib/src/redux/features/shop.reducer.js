...
export const getDispensariesLocal = createAsyncThunk("shop/getDispensariesLocal", async (_, { getState, rejectWithValue }) => {
    try {
        const { location } = getState();
        const { selectLocationType, radius } = location;
        const { coordinates } = location[selectLocationType].address;
        const { data } = await axios.post(urlBuilder.location.organizationsLocal(), {
...
//   }
// );
export const getProductsFromLocal = createAsyncThunk("shop/getProductsFromLocal", async (_, thunkAPI) => {
    try {
...
export const shopSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getDispensariesLocal.fulfilled, (state, { payload }) => {
            ...
            builder.addCase(getProductsFromLocal.fulfilled, (state, { payload }) => {
...
//# sourceMappingURL=shop.reducer.js.map