...
//   }
// );
export const signinUserAsync = createAsyncThunk("user/signinUserAsync", async ({ email, password }, { dispatch, extra, rejectWithValue }) => {
...
const signOutUserAsync = createAsyncThunk("user/signOutUserAsync", async (_, { dispatch, extra, rejectWithValue }) => {
    try {
