import { type Dispensary, dispensaries } from '@gras/data-access';
	...
	<div className="flex flex-row">
		{dispensaries
			.map((dispensary, index) => {
				return <DispensaryCard key={`dispensary-${index}`} dispensary={dispensary} />;
			})
			.concat(<DispensaryCard dispensary={{} as any} />)}
	</div>
);
