...
type CardProps = { className?: string; amountClassName?: string; title?: string; amount?: string | number };

function Card({ className, amountClassName, title, amount, children }: CardProps & PropsWithChildren) {
    const styles = {
        cardContainer:
