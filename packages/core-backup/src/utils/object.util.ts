 ...
 */
function getProperty(obj: any, propName: any) {
 ...
 */
const normalizeUserData = (user: UserCreateType) => {
...
const pruneData = <T extends Record<string, unknown>>(
	data: T,
	fields: (keyof T)[]
) => {
...
function addressObjectIntoArray(user: any): UserCreateType {
 ...
 * @returns Array
 */
function reconcileStateArray<T>(state: T[], payload: T[]) {
