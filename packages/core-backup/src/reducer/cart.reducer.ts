...
const addItem:AsyncThunk = createAsyncThunk<
...
const createOrderForCheckout:AsyncThunk = createAsyncThunk<OrderCreateType, void>(
...
const selectIsCartEmpty = (state: AppState): boolean =>
