...
const getDispensaryById: AsyncThunk = createAsyncThunk(
...
interface DispensaryStateProps {
...
const dispensaryActions = {
	getDispensaryById,
	...dispensarySlice.actions,
};

const dispensaryReducer = dispensarySlice.reducer;

const selectDispensaryState = (state: AppState) => state.dispensary;
