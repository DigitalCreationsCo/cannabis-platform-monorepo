import { type User, type Role, type StaffMember } from '@gras/data-access';
...
//  * @param role
//  */
const hasMembershipRoleAccess = (user: User, role: Role) => {
	if (user.role) {
