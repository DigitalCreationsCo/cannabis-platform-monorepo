...
export async function findArticleById(id: string): Promise<ArticleWithDetails | null> {
    try {
...
export async function createArticle(article: Prisma.ArticleCreateInput): Promise<ArticleWithDetails | null> {
    try {
...
export async function updateArticle(article: Prisma.ArticleUpdateInput): Promise<ArticleWithDetails | null> {
    try {
