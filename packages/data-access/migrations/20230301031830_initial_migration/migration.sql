...
CREATE TABLE `DriverSession` (
    `id` VARCHAR(191) NOT NULL,
    `coordinateDriverId` VARCHAR(191) NOT NULL,
    ...
    UNIQUE INDEX `DriverSession_coordinateDriverId_key`(`coordinateDriverId`),
...
CREATE TABLE `Address` (
    ...
    UNIQUE INDEX `Address_organizationId_key`(`organizationId`),
    INDEX `Address_userId_idx`(`userId`),
    INDEX `Address_organizationId_idx`(`organizationId`),
...
CREATE TABLE `Coordinates` (
    ...
    UNIQUE INDEX `Coordinates_driverId_key`(`driverId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `OrderItem` (
    ...
    UNIQUE INDEX `OrderItem_variantId_key`(`variantId`),
...
CREATE TABLE `_CoordinatesToRoute` (
    ...
    UNIQUE INDEX `_CoordinatesToRoute_AB_unique`(`A`, `B`),
    INDEX `_CoordinatesToRoute_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `_CategoryToCategoryList` (
    `A` VARCHAR(191) NOT NULL,
    `B` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `_CategoryToCategoryList_AB_unique`(`A`, `B`),
    INDEX `_CategoryToCategoryList_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
