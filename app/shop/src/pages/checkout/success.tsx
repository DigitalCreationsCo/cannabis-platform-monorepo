			...
			<Card className="m-auto cursor-default md:max-w-[500px]">
				<Center className="space-y-2">
					...
					<Small>
						...
						appreciates your business and the opportunity to serve
						our community. ❤️
					</Small>
					<Small>
						Your order is being sent to a Gras Delivery Person, and
						will be delivered soon!{'\n'}
						{/* You will receive an email with your order details. */}
						<b>
							Check your sms messages for updates on your order.
						</b>
						{'\n'}
