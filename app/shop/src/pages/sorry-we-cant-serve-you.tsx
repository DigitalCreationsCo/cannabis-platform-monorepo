	...
	return (
		<Page>
			<Center className="m-auto w-[300px] space-y-4 p-4 sm:w-[440px]">
				...
				/>
				<H6>
					Thank you for choosing Delivery by Gras. Unfortunately,
					you're not old enough to enjoy cannabis and hemp products,
					according to federal and state laws. Come back when you're
					21 years or older.
				</H6>
			</Center>
		</Page>
