...
function Button({
	...
	return (
		<div
			onClick={openWidget}
			className={twMerge([styles.capsule, className])}
		>
			{expandWidget ? (
				<div className="flex flex-row items-center">
					...
					<div className="flex flex-col p-2">
						<Paragraph className="m-auto" color="light">
							{dispensaryName || 'Your dispensary'} is teaming up
							with Gras for home delivery.{' '}
						</Paragraph>

						<Small
							className="m-auto text-primary-light"
							color="light"
						>
							Get started at checkout!
						</Small>
					</div>
				...
				<div className="justify-center flex items-center h-full">
					...
					{screenwidth <= md ? (
						<Small color="light" className="items-center">
							Delivery by Gras available at checkout !
						</Small>
					) : (
						<>
							<Small color="light" className="items-center">
								Delivery by Gras{TextContent.char.NBSP}
							</Small>
							<Small color="light" className="items-center">
								now at checkout
							</Small>
