...
(async () => {
	const image = await client.generateImage({
		...
		backgroundFit: 'cover',
		backgroundImageUrl:
			'https://i.picsum.photos/id/946/1200/600.jpg?hmac=UrGWW9DtBMLM25iDKJ7zqbYKkzfc50TFUmjX-o9coOk',
	...
	fs.writeFileSync(path.join(__dirname, './output/sample.jpg'), image);
})();
