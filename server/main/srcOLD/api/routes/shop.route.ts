...
import { shopCtrl, orgCtrl, orderCtrl } from "../controllers";
const router = Router();
...
router.route("/create-order").post(shopCtrl.createOrder)
// get vendor details by vendorId
router.route("/get-vendor/:id").get(orgCtrl.apiGetVendor);
...
router.route("/").get(orgCtrl.getVendorByLocation)
