...
var _express3 = require("supertokens-node/recipe/session/framework/express");
var _SessionDA = _interopRequireDefault(require("./api/data-access/SessionDA"));
...
app.get('/api/v1/session', (0, _express3.verifySession)(), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _session, sessionFromDb, user, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return _SessionDA["default"].getSession(_session.getHandle());
        case 6:
          sessionFromDb = _context.sent;
          console.log('session from db: ', sessionFromDb);
          user = sessionFromDb.user, session = _objectWithoutProperties(sessionFromDb, _excluded);
          res.status(200).json({
            status: true,
            session: {
              session: session
...
app.use('/api/v1/error', _routes.errorRoute);
