...
var OrderInfo = /*#__PURE__*/function (_Order) {
  _inherits(OrderInfo, _Order);
  var _super = _createSuper(OrderInfo);
  function OrderInfo(_ref) {
    var _this;
    var _ref$orderId = _ref.orderId,
      orderId = _ref$orderId === void 0 ? new ObjectId() : _ref$orderId,
      _ref$customer = _ref.customer,
      customer = _ref$customer === void 0 ? {
      ...
      createdOn = _ref$createdOn === void 0 ? createDate() : _ref$createdOn,
      _ref$driverPath = _ref.driverPath,
      driverPath = _ref$driverPath === void 0 ? [] : _ref$driverPath;
