...
var Vendor = /*#__PURE__*/function () {
  function Vendor() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$vendorId = _ref.vendorId,
      vendorId = _ref$vendorId === void 0 ? new _mongodb.ObjectId() : _ref$vendorId,
      email = _ref.email,
  ...
  _createClass(Vendor, [{
    ...
    value: function encoded() {
      ...
      }, this.toJson()), process && process.env && process.env.VENDOR_SECRET_KEY || undefined);
    }
  }], [{
    key: "decoded",
    value: function () {
      var _decoded = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(vendorJwt) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", _jsonwebtoken["default"].verify(vendorJwt, process && process.env && process.env.SECRET_KEY || undefined, function (error, decoded) {
                if (error) {
                  return {
                    error: error
                  };
