...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // import { MailerService } from '../../email/mailerService';
/* =================================
...
var SessionController = /*#__PURE__*/function () {
  ...
  _createClass(SessionController, null, [{
    key: "getSession",
    value: function () {
      var _getSession = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              sessionData = _session["default"].getSession(req, res);
    ...
    key: "sendPasswordResetTokenEmail",
    value: function () {
      var _sendPasswordResetTokenEmail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var email, token, timeLimitedToken, user;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              email = req.body;
              token = (0, _utility.createToken)();
              timeLimitedToken = "".concat((0, _utility.sha265hex)(token), "#").concat((Date.now() + Number(process && process.env && process.env.PASSWORD_RESET_EXPIRY_MINS || "15") * 60000).toString());
              _context2.next = 6;
              return _dataAccess.UserDA.updatePasswordToken(email, timeLimitedToken);
            case 6:
              user = _context2.sent;
              if (user) {
              ...
              console.log("User ".concat(user.id, " requested password reset"));
              _context2.next = 15;
              break;
            case 11:
              _context2.prev = 11;
      ...
      function sendPasswordResetTokenEmail(_x3, _x4) {
        return _sendPasswordResetTokenEmail.apply(this, arguments);
      }
      return sendPasswordResetTokenEmail;
    }() // NOT FINISHED
  }, {
    key: "doResetPassword",
    value: function () {
      var _doResetPassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
      ...
      function doResetPassword(_x5, _x6) {
