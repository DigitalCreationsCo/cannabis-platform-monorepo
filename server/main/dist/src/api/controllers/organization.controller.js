...
================================= */
var OrganizationController = /*#__PURE__*/function () {
  function OrganizationController() {
    _classCallCheck(this, OrganizationController);
  }
  _createClass(OrganizationController, null, [{
    key: "createOrganization",
    value: function () {
      var _createOrganization = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var organization, coordinates, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _sharedLib.getGeoCoordinatesByAddress)(organization.address);
            case 4:
              coordinates = _context.sent;
              if (coordinates) organization.address.coordinates = coordinates;
              _context.next = 8;
              return _dataAccess.OrganizationDA.createOrganization(organization);
            case 8:
              data = _context.sent;
              if (data) {
                _context.next = 11;
              ...
              return _context.abrupt("return", res.status(404).json('Organization could not be created.'));
            case 11:
              return _context.abrupt("return", res.status(201).json(data));
            case 14:
              _context.prev = 14;
              _context.t0 = _context["catch"](0);
              console.log('API error: ', _context.t0.message);
              res.status(500).json({
    ...
    value: function () {
      var _getOrganizationById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return _dataAccess.OrganizationDA.getOrganizationById(organizationId);
            case 4:
              data = _context2.sent;
              if (data) {
                _context2.next = 7;
              ...
              return _context2.abrupt("return", res.status(404).json('Organization not found'));
            case 7:
    ...
    key: "getCategoryList",
    value: function () {
      var _getCategoryList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var organizationId, data;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              organizationId = req.params.id || '';
              _context3.next = 4;
              return _dataAccess.OrganizationDA.getCategoryList(organizationId);
            case 4:
              data = _context3.sent;
              if (data) {
                _context3.next = 7;
              ...
              return _context3.abrupt("return", res.status(404).json('Categories not found'));
            case 7:
      ...
      function getCategoryList(_x5, _x6) {
    ...
    value: function () {
      var _getUsersByOrganization = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var organizationId, data;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              organizationId = req.params.id || '';
              _context4.next = 4;
              return _dataAccess.OrganizationDA.getUsersByOrganization(organizationId);
            case 4:
              data = _context4.sent;
              if (data) {
                _context4.next = 7;
              ...
              return _context4.abrupt("return", res.status(404).json('Organization not found'));
            case 7:
      ...
      function getUsersByOrganization(_x7, _x8) {
    ...
    value: function () {
      var _updateProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        var id, busboy, uploadStartTime, busboyFinishTime, s3UploadFinishTime;
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              try {
                ...
                uploadStartTime = new Date(), busboyFinishTime = null, s3UploadFinishTime = null;
